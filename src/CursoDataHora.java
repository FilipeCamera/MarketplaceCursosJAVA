...
public class CursoDataHora extends Curso {
	
	private int diaIni, mesIni, anoIni, horaIni, minutoIni;
	private int diaEnc, mesEnc, anoEnc, horaEnc, minutoEnc;
	
	public CursoDataHora(String nomeCurso, double preco, int diaIni, int mesIni, int anoIni, int horaIni, int minutoIni, int diaEnc,
