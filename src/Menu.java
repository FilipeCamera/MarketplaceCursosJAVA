					...
					if(tipoCurso!=1){
						...
						if(tipoCurso==2) {
							...
							Curso curso = new Curso(nomeCurso,"codigo",preco,vagas,false,
									true,false,diaIni, mesIni, anoIni, horaIni, minutoIni, diaEnc, mesEnc, anoEnc, horaEnc, minutoEnc, user.getId());
							BancoDeDados.armazenarCurso(curso);}

						if(tipoCurso==3) {
							Curso curso= new Curso(nomeCurso,"codigo",preco,false,false,true,diaIni, mesIni, anoIni, horaIni, minutoIni, diaEnc, mesEnc, anoEnc, horaEnc, minutoEnc, user.getId());
							BancoDeDados.armazenarCurso(curso);
						}
					}else{	
						Curso curso= new Curso(nomeCurso,"codigo",preco,true,false,false, user.getId());
						BancoDeDados.armazenarCurso(curso);
					}
