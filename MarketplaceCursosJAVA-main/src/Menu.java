...
// Classe Menu - respons·vel pela interaÁ„o com o usu·rio contendo 10 funcionalidades indo de 0 a 9

public class Menu {

	// funÁ„o que ir· exibir o menu
	public void exibirMenu() {
		...
		while (ativo) {
			...
			// caminho que a plataforma ir√° seguir de acordo com as instru√ßoes do usu√°rio
			switch (options) {
			case 0:
				
				// apresenta a tela de fazer o registro e retorna o usu√°rio
				usuario = new TelaDeRegistrarOuAutenticarUsuario().fazerRegistro(entrada);
				break;
			case 1:
				
				// apresenta a tela de fazer autentica√ß√£o e retorna o usu√°rio
				usuario = new TelaDeRegistrarOuAutenticarUsuario().autenticar(entrada);
				break;

			case 2:
				
				// apresenta a tela com os cursos disponÌveis na plataforma
